...
--Este es el archivo de mi base de datos.
...
No funciono y no tenia tiempo agregar otro rol de vendedor, quedara como admin y secretaria, pero si funcionaron los alter 1 y 3, el 2 no
--ALTER PROCEDURE PARA REGISTRAR
ALTER PROCEDURE seg.sp_RegistrarUsuario
    @Usuario     VARCHAR(50),
    @Nombres     VARCHAR(100),
    @Apellidos   VARCHAR(100),
...
----2 USER
ALTER PROCEDURE seg.sp_ActualizarUsuario
    @IdUsuario   INT,
    @Nombres     VARCHAR(100),
    @Apellidos   VARCHAR(100),
    @Correo      VARCHAR(120),
...
BEGIN
    ...
    IF NOT EXISTS(SELECT 1 FROM seg.tbUsuario WHERE IdUsuario=@IdUsuario)
    BEGIN SET @Mensaje=N'Usuario no encontrado'; RETURN 404; END
...
---3 REGISTRAR
ALTER PROCEDURE seg.sp_RegistrarUsuarioAdmin
    @Usuario     VARCHAR(50),
    @Nombres     VARCHAR(100),
    @Apellidos   VARCHAR(100),
    @Correo      VARCHAR(120),
...
BEGIN
    ...
    SET @Mensaje=N'Usuario creado por administrador';
    RETURN 0;
END;
GO
