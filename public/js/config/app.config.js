...
// ================================================================================
// ✅ COMPLETAMENTE FUNCIONAL: Configuración centralizada del sistema
// Estado: Operativo - Define parámetros globales de toda la aplicación
//
// Propósito:
//   Centraliza toda la configuración parametrizable del sistema en un solo lugar.
//   Facilita cambios globales sin necesidad de modificar múltiples archivos.
//   Soporta diferentes ambientes (development, staging, production).
//
// Secciones de configuración:
//   ✅ app: Información de la aplicación (nombre, versión, ambiente)
//   ✅ api: Configuración de API (baseUrl, timeout, endpoints)
//   ✅ ui: Configuración de interfaz (temas, idioma, animaciones, toasts, modales)
//   ✅ pagination: Configuración de paginación (tamaños, opciones)
//   ✅ search: Configuración de búsqueda (debounce, caracteres mínimos)
//   ✅ validation: Reglas de validación (contraseñas, usuarios, emails, teléfonos)
//   ✅ security: Configuración de seguridad (sesión, bloqueos, reCAPTCHA)
//   ✅ cache: Configuración de caché (duración, estrategias)
//   ✅ logging: Configuración de logs (nivel, destino)
//   ✅ files: Configuración de archivos (tamaños, tipos permitidos)
//   ✅ format: Configuración de formatos (fechas, números, moneda)
//   ✅ roles: Configuración de roles y permisos
//   ✅ dashboard: Configuración del dashboard (refresh, vista por defecto)
//   ✅ tables: Configuración de tablas (ordenamiento, columnas visibles)
//   ✅ email: Configuración de correo electrónico (proveedor, templates)
//   ✅ development: Configuración de desarrollo (mockData, debugging)
//   ✅ features: Feature flags para habilitar/deshabilitar funcionalidades
//
// Métodos helper:
//   - getEndpoint(name, params): Obtiene URL de endpoint con parámetros
//   - hasPermission(role, permission): Verifica si rol tiene permiso
//   - isFeatureEnabled(feature): Verifica si feature está habilitado
//   - isDevelopment(): Verifica si está en modo desarrollo
//   - isProduction(): Verifica si está en modo producción
//
// Uso en el sistema:
//   - Todos los módulos consultan esta configuración
//   - Evita hardcoding de valores
//   - Facilita cambios de configuración según ambiente
//   - Soporta feature flags para despliegues incrementales
//
// Notas importantes:
//   ⚠️ Algunos endpoints configurados no están implementados en el backend:
//      - Productos, Categorías, Inventario, Ventas, Reportes
//   ✅ Endpoints funcionales:
//      - Usuarios (/api/usuarios)
//      - Bitácoras (/api/bitacora/accesos, /api/bitacora/transacciones)
//      - Dashboard Stats (/api/dashboard-stats)
//      - Login/Logout (/api/login, /api/logout)
//
// Dependencias: Ninguna (archivo de configuración base)
// ================================================================================
